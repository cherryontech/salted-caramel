...
const careerPath = [
  {
    ...
    career: "Web Design",
    description:
      "Research, plan, and improve website apps based on user needs.",
  },
  {
    icon: "Upload.svg",
  ...
  return (
    <div className="flex ml-15 gap-[100px]">
      ...
      <aside className="flex flex-col">
        <img
          src={getImageSrc("BuildYourDashboard.svg")}
          alt="illustration"
          className="w-[327px] h-[263px] object-contain self-stretch"
        />
      ...
      <div className="flex-1 flex-col w-[520px]">
        ...
        <p className="text-gray-600 text-[16px] italic mt-1">
          Choose one of All Roads' pre-built roadmaps, and customize it on your
          dashboard.
        </p>
