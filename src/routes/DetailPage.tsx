    ...
    <>
      ...
      <div className="max-w-5xl mx-auto mt-12">
        ...
        <section>
          ...
          <div className="mt-13 grid grid-cols-3 gap-x-12 gap-y-1 justify-items-center mx-auto max-w-5xl">
            {[...item.technicalSkills, ...item.softSkills].map(
              (skill, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center text-center w-full max-w-[250px]"
                >
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-x-15 gap-y-9 p-15 justify-items-center mx-auto max-w-5xl">
